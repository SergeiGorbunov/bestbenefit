          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-10 max-w-2xl">
                Оптимальные решения для бизнеса с экономией до 40% без потери
                качества
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  onClick={() => openFormWithTariff(null)}
                  className="bg-gradient-to-r from-orange-500 to-orange-700 hover:from-orange-600 hover:to-orange-800 px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 hover:scale-105 shadow-lg shadow-orange-500/30"
                >
                  Рассчитать стоимость
                </button>
                <Link
                  href="services"
                  className="border-2 text-center border-orange-600 text-orange-400 hover:bg-orange-900/30 px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300"
                >
                  Наши услуги
                </Link>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">
              Наши логистические преимущества
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[1, 2, 3, 4, 5, 6].map((item) => (
              <div
                key={item}
                className="relative aspect-video rounded-2xl overflow-hidden border border-orange-900/50"
              >
                ...
                <div className="absolute inset-0 bg-orange-500/10 border-2 border-dashed border-orange-500/30 flex items-center justify-center">
                  ...
                  <Image
                    src={`/images/ware${item}.jpg`}
                    alt="Gallery"
                    width={1000}
                    height={1000}
                  />
                  {item === 1 && (
                    <p className="flex gap-2 items-center p-3 pl-0 absolute bottom-4 right-4 bg-black/80 backdrop-blur-sm text-orange-400 text-sm font-medium py-1 px-3 rounded-full border border-orange-500/30 z-10">
                      <Image
                        alt="star"
                        src="/images/star.png"
                        width={30}
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-20">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Выберите оптимальное решение под ваши задачи. Все тарифы включают
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 max-w-8xl mx-auto">
            ...
            <div className="bg-gradient-to-b from-gray-900 to-black border border-gray-800 rounded-3xl overflow-hidden transition-all duration-500 hover:-translate-y-4">
              <div className="p-8 border-b border-gray-800">
                <h3 className="text-2xl font-bold mb-2">Медленный</h3>
                <p className="text-gray-400 mb-6">Для неторопливых грузов</p>
                <div className="flex items-end mb-6">
                  <span className="text-4xl font-bold">от $1.80</span>
            ...
            <div className="bg-gradient-to-b from-gray-900 to-black border border-gray-800 rounded-3xl overflow-hidden transition-all duration-500 hover:-translate-y-4">
              <div className="p-8 border-b border-gray-800">
                <h3 className="text-2xl font-bold mb-2">Средний</h3>
                <p className="text-gray-400 mb-6">Для средних поставок</p>
                <div className="flex items-end mb-6">
                  <span className="text-4xl font-bold">от $2.00</span>
                  <span className="text-gray-500 ml-2">/кг</span>
                </div>
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center">
            ...
            <div className="relative bg-gradient-to-b from-gray-900 to-black border-2 border-orange-500 rounded-3xl overflow-hidden transition-all duration-500 hover:-translate-y-4 scale-105 z-20 shadow-xl shadow-orange-500/20">
              ...
              <div className="p-8 border-b border-gray-800">
                <h3 className="text-2xl font-bold mb-2">Быстрый</h3>
                <p className="text-gray-400 mb-6">
                  Когда нужно срочно получить груз
                </p>
                <div className="flex items-end mb-6">
                  <span className="text-4xl font-bold">от $2.50</span>
                  <span className="text-gray-500 ml-2">/кг</span>
                </div>
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center">
            ...
            <div className="bg-gradient-to-b from-gray-900 to-black border border-gray-800 rounded-3xl overflow-hidden transition-all duration-500 hover:-translate-y-4">
              <div className="p-8 border-b border-gray-800">
                <h3 className="text-2xl font-bold mb-2">Авиа</h3>
                <p className="text-gray-400 mb-6">Срочная доставка</p>
                <div className="flex items-end mb-6">
                  <span className="text-4xl font-bold">от $20.00</span>
                  <span className="text-gray-500 ml-2">/кг</span>
                </div>
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center">
