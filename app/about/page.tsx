...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <section className="relative z-10 pt-32 pb-20 px-4">
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            {" "}
            {/* Уменьшен gap для мобильных */}
            <div>
              <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold mb-6">
                {" "}
                {/* Адаптивные размеры текста */}О компании{" "}
              ...
              <p className="text-lg md:text-xl text-gray-300 mb-8">
                {" "}
                {/* Адаптивный текст */}
                Ваш надежный партнер в логистике из Китая с 2014 года. Мы
                специализируемся на комплексных решениях под ключ для бизнеса.
              </p>
            ...
            <div className="relative aspect-video rounded-3xl overflow-hidden border-2 border-orange-500/30 mt-8 lg:mt-0">
              {" "}
              {/* Добавлен отступ сверху для мобильных */}
      ...
      <section className="relative z-10 py-16 md:py-20 bg-gradient-to-b from-black to-gray-900/50 px-4">
        ...
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto text-center mb-12 md:mb-16">
            {" "}
            {/* Уменьшен mb для мобильных */}
            <h2 className="text-2xl md:text-3xl font-bold mb-4">
              Наша миссия и ценности
            </h2>{" "}
            {/* Адаптивный текст */}
            <div className="w-16 h-1 bg-orange-500 mx-auto rounded-full mb-6 md:mb-8"></div>{" "}
            {/* Уменьшен mb */}
            <p className="text-lg md:text-xl text-gray-300">
              {" "}
              {/* Адаптивный текст */}
              Мы стремимся стать вашим надежным логистическим партнером,
              обеспечивая максимальную выгоду и минимальные риски при работе с
      ...
      <section className="relative z-10 py-16 md:py-20 px-4">
        ...
        <div className="container mx-auto">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="relative pl-6 md:pl-8 border-l-2 border-orange-500/30">
              {" "}
      ...
      {/* Преимущества */}
      <section className="relative z-10 py-16 md:py-20 bg-gradient-to-b from-gray-900/50 to-black px-4">
        {" "}
        {/* Добавлен px-4 */}
        <div className="container mx-auto">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto text-sm md:text-base">
              {" "}
              {/* Адаптивный текст */}
              Почему клиенты выбирают VIPAZA CARGO для логистики из Китая
            </p>
          </div>
      ...
      <section className="relative z-10 py-16 md:py-20 px-4">
        ...
        {/* Добавлен px-4 */}
        <div className="container mx-auto">
          <div className="bg-gradient-to-r from-orange-900/20 to-black border border-orange-900/50 rounded-3xl p-6 md:p-8 lg:p-12 backdrop-blur-sm">
            {" "}
            {/* Уменьшен padding */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 md:gap-8">
              ...
              {stats.map((stat, index) => (
                <div key={index} className="text-center p-2 md:p-4">
                  {" "}
                  {/* Уменьшен padding */}
                  <div className="text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent mb-2 md:mb-4">
                    {" "}
                    {/* Адаптивный текст */}
                    {stat.value}
                  </div>
            ...
            {team.map((member, index) => (
              ...
              >
                <div className="relative h-48 md:h-64">
                  {" "}
                  {/* Уменьшена высота для мобильных */}
                  <div className="absolute inset-0 bg-orange-500/10 flex items-center justify-center">
                    <div className="bg-gradient-to-br from-black/70 to-orange-900/10 w-full h-full flex items-center justify-center">
                      <span className="text-orange-500/50 font-mono text-xs">
                        Photo: {member.name}
                      </span>{" "}
                      {/* Уменьшен текст */}
                    </div>
                ...
                <div className="p-4 md:p-6">
                  ...
                  {/* Адаптивный текст */}
                  <p className="text-orange-500 text-sm md:text-base mb-1 md:mb-3">
                    {member.position}
                  </p>{" "}
                  {/* Адаптивный текст */}
      ...
      {/* CTA Section */}
      <section className="relative z-10 py-16 md:py-28 px-4">
        {" "}
        {/* Добавлен px-4 */}
        <div className="container mx-auto">
          <div className="bg-gradient-to-r from-orange-900/30 to-black border border-orange-900/50 rounded-3xl p-4 md:p-6 lg:p-8 xl:p-12 backdrop-blur-sm">
            {" "}
            {/* Уменьшен padding */}
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-gray-300 mb-6 md:mb-10 text-sm md:text-base lg:text-xl">
                {" "}
                {/* Адаптивный текст */}
              ...
              <div className="max-w-md mx-auto">
                {!isFormOpen ? (
                  ...
                  <OrderForm
                    selectedService={"Со страницы о нас"}
